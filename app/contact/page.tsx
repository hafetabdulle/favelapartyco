...
${formData.message}`;
  ...
  return (
    <div className="pt-28 sm:pt-32 bg-white">
      ...
      {/* CTA */}
      <section className="py-16 sm:py-20 bg-neutral-50 relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-0 right-0 w-96 h-96 bg-[#009739] rounded-full translate-x-1/2 -translate-y-1/2" />
        </div>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <motion.div
            ...
            className="space-y-5"
          >
            <h2 className="font-display font-semibold text-neutral-900" style={{ fontSize: 'clamp(1.6rem, 4vw, 2.6rem)' }}>
              Ready to explore <em className="italic text-[#009739]">Rio?</em>
            </h2>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 min-h-[52px] px-8 py-3 bg-[#009739] hover:bg-[#006B28] text-white rounded-full font-semibold text-base transition-all duration-200 shadow-lg"
            >
